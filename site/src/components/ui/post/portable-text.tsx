...
const components: PortableTextComponents = {
    ...
    block: {
        ...
        blockquote: ({ children }) => (
            <blockquote className="border-l-4 border-l-muted-foreground pl-4 italic text-muted-foreground my-4">
                {children}
            </blockquote>
        ),
    },
...
export default function PTComponent({ content }: PostBodyProps) {
    return (
        <div>
